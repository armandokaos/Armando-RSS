...
async function publishProV2() {
  console.log(`[1️⃣] Fetching calldata from the API for the edit in Space ${spaceId}...`);
  ...
  try {
    ...
    console.log("[DEBUG] 'to' address returned by API:", to);
    console.log("[DEBUG] 'data' payload returned by API:", data);
